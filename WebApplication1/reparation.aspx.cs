    ...
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    DropDownList3.DataTextField = "matricule";
                    DropDownList3.DataValueField = "N";
                    DropDownList3.DataBind();
                    DropDownList2.DataSource = dt;
                    DropDownList2.DataTextField = "matricule";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
           ...
           foreach(var item in ListBox1.Items)
            ...
            ClassCon.connect();
              ClassCon.sqlconnection("insert into test1 values('" + DropDownList3.SelectedItem.Text + "','" + Kilomitrage.Text + "','" + DropDownList4.SelectedItem.Text + "','" + date_entree.Text + "','" + s + "','" + Session["count"] + "','"+ Session["nn"].ToString() + "')");
                ClassCon.con.Close();
            TextBox2.Text = s;
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            try
            {
                ...
                DropDownList3.SelectedItem.Text = GridView1.Rows[r].Cells[2].Text;
                Kilomitrage.Text = GridView1.Rows[r].Cells[3].Text;
                DropDownList1.SelectedItem.Text = GridView1.Rows[r].Cells[6].Text;
                DropDownList4.SelectedItem.Text = GridView1.Rows[r].Cells[4].Text;
               // TextBox1.Text = GridView1.Rows[r].Cells[7].Text;
                DropDownList2.SelectedItem.Text = GridView1.Rows[r].Cells[2].Text;
                // date_entree.Text = GridView1.Rows[r].Cells[5].Text;
                //date_entree.Text = "01-02-2010";
                date_entree.Text = DateTime.Now.ToString(GridView1.Rows[r].Cells[5].Text);
            }
            catch
            {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                ClassCon.connect();
                string req = "delete  from test1 where matricule='" + DropDownList3.SelectedItem + "'";
                ClassCon.sqlconnection(req);
                ClassCon.con.Close();
