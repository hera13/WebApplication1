<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Affichageslesvehicule.aspx.cs" Inherits="WebApplication1.Affichageslesvehicule1" %>
 ...
 <p class="font-italic" style="margin-top:5% ; margin-left:15%">Recherch par :</p>
  ...
  <div class="form-row" style=" width:30% ; margin-left:2% ; " >
    ...
    <div class="form-row" style=" width:30% ; margin-left:2% ; margin-top:"">
      ...
      <input type="text" class="form-control" id="Marque" runat="server"  style="height:45% ;  margin-top:-1.5%">  
    </div>
   

            <div class="col-md-4 mb-3">
                <asp:Button class="btn btn-outline-warning" ID="Button4" runat="server" Text="Recherche" style="margin-top:25px" OnClick="Button4_Click" />
    </div>
    <div class="col-md-4 mb-3">
    ...
    <div class="col-md-4 mb-3">
      <label class="text-primary" for="validationCustom01" style="font-size:small" >Immatriculation:</label>
        ...
        <asp:TextBox ID="immat" class="form-control" runat="server" style="height:45%" ReadOnly="True" ></asp:TextBox>
     
    </div>
    <div class="col-md-4 mb-3">
      <label class="text-primary" for="validationCustom02" style="font-size:small">date mise en service</label>
        
        <asp:TextBox ID="date" runat="server" TextMode="Date" class="form-control" style="height:45%"></asp:TextBox>
    </div>

       <div class="col-md-4 mb-3">
      <label class="text-primary" for="validationCustom02" style="font-size:small">Marque </label>
      
           <asp:TextBox class="form-control" ID="marque_M" runat="server" style="height:45%"></asp:TextBox>
    </div>
    </div>
    ...
    <div class="col-md-4 mb-3">
      <label class="text-primary" for="validationCustom01" style="font-size:small" >Type</label>
        ...
        <asp:TextBox class="form-control" ID="type_M" runat="server" style="height:45%"></asp:TextBox>
     
    </div>
    <div class="col-md-4 mb-3">
      <label class="text-primary" for="validationCustom02" style="font-size:small">Numero de cagre</label>
      <asp:TextBox class="form-control" ID="NDG_M" runat="server" style="height:45%"></asp:TextBox>
    </div>

   <div class="col-md-4 mb-3">
      <label class="text-primary" for="validationCustom02" style="font-size:small">Genre</label>
      <asp:TextBox class="form-control" ID="genre_M" runat="server" style="height:45%"></asp:TextBox> 
    </div>
    </div>
  ...
  <asp:TextBox class="form-control" ID="PF_M" runat="server" style="height:45%"></asp:TextBox>
     
    </div>
    <div class="col-md-4 mb-3">
      <label class="text-primary" for="validationCustom02" style="font-size:small">Carbulant</label>
     <asp:DropDownList class="form-control" ID="Carbulant_M" runat="server" style="height:50%"></asp:DropDownList>  
    </div>
   ...
   <div class="col-md-4 mb-3">
    ...
    <div class="col-md-4 mb-3">
          <label class="text-primary" for="validationCustom02" style="font-size:small">Organisme</label>
       <asp:DropDownList class="form-control" ID="Organisme_M" runat="server" style="height:50%"></asp:DropDownList>  
  
     
    </div>
    <div class="col-md-4 mb-3">
      <label class="text-primary" for="validationCustom02" style="font-size:small">Service</label>
      <asp:DropDownList class="form-control" ID="serv_M" runat="server" style="height:50%"></asp:DropDownList>  
    </div>
